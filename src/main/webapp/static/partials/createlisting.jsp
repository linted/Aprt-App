                                ...
                                <div id="collapseFour" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingFour">
                                    <div class="panel-body">
                                        <div class="col-md-6">
                                            <div class="checkbox">
                                                <label for="water">
                                                    <input ng-model="water" type="checkbox" value="true"> Water
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="heat">
                                                    <input ng-model="heat" type="checkbox" value="true"> Heat
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="electricity">
                                                    <input ng-model="electricity" type="checkbox" value="true"> Electricity
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="gas">
                                                    <input ng-model="gas" type="checkbox" value="true"> Gas
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="checkbox">
                                                <label for="cable">
                                                    <input ng-model="cable" type="checkbox" value="true"> Cable
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="phone">
                                                    <input ng-model="phone" type="checkbox" value="true"> Phone
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="trash">
                                                    <input ng-model="trash" type="checkbox" value="true"> Trash
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="checkbox">
                                                <label for="lockChanges">
                                                    <input ng-model="lockChanges" type="checkbox" value="true"> Lock Changes
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="deadbolts">
                                                    <input ng-model="deadbolts" type="checkbox" value="true"> Deadbolts
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="peepholes">
                                                    <input ng-model="peepholes" type="checkbox" value="true"> Peepholes
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="balconyLock">
                                                    <input ng-model="balconyLock" type="checkbox" value="true"> Balcony Lock
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="exteriorLocks">
                                                    <input ng-model="exteriorLocks" type="checkbox" value="true"> Exterior Locks
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="checkbox">
                                                <label for="batterySmokeDetectors">
                                                    <input ng-model="batterySmokeDetectors" type="checkbox" value="true"> Battery Smoke Detectors
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="hardWiredSmokeDetectors">
                                                    <input ng-model="hardWiredSmokeDetectors" type="checkbox" value="true"> Hard Wired Smoke Detectors
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="carbonDioxideDetector">
                                                    <input ng-model="carbonDioxideDetector" type="checkbox" value="true"> CO2 Detector
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="fireExtinguisher">
                                                    <input ng-model="fireExtinguisher" type="checkbox" value="true"> Fire Extinguisher
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="exteriorLighting">
                                                    <input ng-model="exteriorLighting" type="checkbox" value="true"> Exterior Lighting
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="checkbox">
                                                <label for="safetyInspections">
                                                    <input ng-model="safetyInspections" type="checkbox" value="true"> Safety Inspections
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="securityAlarm">
                                                    <input ng-model="securityAlarm" type="checkbox" value="true"> Security Alarm
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="securityCameras">
                                                    <input ng-model="securityCameras" type="checkbox" value="true"> Security Cameras
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="securityGuard">
                                                    <input ng-model="securityGuard" type="checkbox" value="true"> Security Guard
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="gatedCommunity">
                                                    <input ng-model="gatedCommunity" type="checkbox" value="true"> Gated Community
                                                </label>
                                            </div>
                                        </div>
                                    </div>
