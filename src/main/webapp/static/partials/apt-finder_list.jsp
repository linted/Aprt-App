        ...
        <div class="container-fluid">
            ...
            <section id="rightColumn">
                ...
                <section id="rightTopSortBar">
                    <span>Total Listings: {{ctrl.resultingListings.length}}</span>
                ...
                <section ng-if="!mode">
                    ...
                    <section class="allListings" ng-repeat="x in ctrl.listings | filter : { orgID : '!' } | filter: strictFilters:strict | filter: looseFilters | filter:filterPrice | limitTo:totalDisplayed as resultingListings">
