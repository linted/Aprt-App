        ...
        <div class="container-fluid">
            ...
            <section id="rightColumn">
                ...
                <section ng-if="!mode">
                    ...
                    <section class="allListings" ng-repeat="x in ctrl.listings | filter : { orgID : '!' } | filter: strictFilters | filter: looseFilters | filter:filterPrice | limitTo:totalDisplayed as ctrl.resultingListings">
