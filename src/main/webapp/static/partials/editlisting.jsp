                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-md-6">
                                            <fieldset class="form-group has-error">
                                                ...
                                                <input id="locationTxt" type="text" class="form-control" placeholder="1971 University Blvd. Lynchburg, VA 24501" ng-model="ctrl.listing.streetAddress">
                                ...
                                <div id="collapseFour" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingFour">
                                    <div class="panel-body">
                                        <div class="col-md-6">
                                            <div class="checkbox">
                                                <label for="water">
                                                    <input ng-model="ctrl.listing.water" type="checkbox" value="true"> Water
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="heat">
                                                    <input ng-model="ctrl.listing.heat" type="checkbox" value="true"> Heat
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="electricity">
                                                    <input ng-model="ctrl.listing.electricity" type="checkbox" value="true"> Electricity
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="gas">
                                                    <input ng-model="ctrl.listing.gas" type="checkbox" value="true"> Gas
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="checkbox">
                                                <label for="cable">
                                                    <input ng-model="ctrl.listing.cable" type="checkbox" value="true"> Cable
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="phone">
                                                    <input ng-model="ctrl.listing.phone" type="checkbox" value="true"> Phone
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="trash">
                                                    <input ng-model="ctrl.listing.trash" type="checkbox" value="true"> Trash
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="checkbox">
                                                <label for="lockChanges">
                                                    <input ng-model="ctrl.listing.lockChanges" type="checkbox" value="true"> Lock Changes
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="deadbolts">
                                                    <input ng-model="ctrl.listing.deadbolts" type="checkbox" value="true"> Deadbolts
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="peepholes">
                                                    <input ng-model="ctrl.listing.peepholes" type="checkbox" value="true"> Peepholes
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="balconyLock">
                                                    <input ng-model="ctrl.listing.balconyLock" type="checkbox" value="true"> Balcony Lock
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="exteriorLocks">
                                                    <input ng-model="ctrl.listing.exteriorLocks" type="checkbox" value="true"> Exterior Locks
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="checkbox">
                                                <label for="batterySmokeDetectors">
                                                    <input ng-model="ctrl.listing.batterySmokeDetectors" type="checkbox" value="true"> Battery Smoke Detectors
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="hardWiredSmokeDetectors">
                                                    <input ng-model="ctrl.listing.hardWiredSmokeDetectors" type="checkbox" value="true"> Hard Wired Smoke Detectors
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="carbonDioxideDetector">
                                                    <input ng-model="ctrl.listing.carbonDioxideDetector" type="checkbox" value="true"> CO2 Detector
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="fireExtinguisher">
                                                    <input ng-model="ctrl.listing.fireExtinguisher" type="checkbox" value="true"> Fire Extinguisher
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="exteriorLighting">
                                                    <input ng-model="ctrl.listing.exteriorLighting" type="checkbox" value="true"> Exterior Lighting
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="checkbox">
                                                <label for="safetyInspections">
                                                    <input ng-model="ctrl.listing.safetyInspections" type="checkbox" value="true"> Safety Inspections
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="securityAlarm">
                                                    <input ng-model="ctrl.listing.securityAlarm" type="checkbox" value="true"> Security Alarm
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="securityCameras">
                                                    <input ng-model="ctrl.listing.securityCameras" type="checkbox" value="true"> Security Cameras
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="securityGuard">
                                                    <input ng-model="ctrl.listing.securityGuard" type="checkbox" value="true"> Security Guard
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="gatedCommunity">
                                                    <input ng-model="ctrl.listing.gatedCommunity" type="checkbox" value="true"> Gated Community
                                                </label>
                                            </div>
                                        </div>
                                    </div>
